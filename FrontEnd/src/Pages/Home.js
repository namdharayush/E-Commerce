...
const Home = () => {
  ...
  const [textCreate , setTextCreate] = useState("Free Delivery");
  ...
  const text = document.getElementsByClassName("custom_text")

  const textCut = () =>{
    setTimeout(() => {
      text.textContent = "Good Stability"
    },0);
    // setTimeout(() => {
    //   text.textContent = "Free Delivery"
    // },4000);
  }
