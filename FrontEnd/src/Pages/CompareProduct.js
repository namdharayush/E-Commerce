...
const CompareProduct = () => {
  const { products  , productsTablet , productsAccessories} = useProductContext();
  ...
  const handleClick = () => {
    const filterSearchProduct = productsTablet.filter((cur) => {
      if (firstCompare == "" || secondCompare === firstCompare) {
        return setResults();
      } else if (
  ...
  const handleClickSecond = () => {
    const filterSearchProduct = productsTablet.filter((cur) => {
      if (secondCompare == "" || secondCompare === firstCompare) {
                          ...
                          return (
                            <>
                              ...
                              <tr>
                                ...
                                <td>{eee.Secondary_Camera_Available}</td>
                              </tr>
                              <tr>
